...
-   `containerHTMLElement` **([Window][46] \| [HTMLElement][47])** the container element for the board canvas
-   `url` **[string][48]** The URL to download the base image.
...
Returns **[Promise][49]&lt;Canvas>** the html canvas instance of the board.
...
Returns **[Array][50]** Associative Array
...
-   `tool` **[String][48]** can be BoardController.TOOL_BRUSH, BoardController.TOOL_MAGIC_WAND or BoardController.TOOL_POLYGON

## addLayer

Add a new layer and select it

Returns **[Object][51]** object with info of the created layer {id,name,color,hexColor,rgbColor,hsvColor,whiteLevel,blackLevel}
...
Returns **[Object][51]** object with info of the selected layer {id,name,color,hexColor,rgbColor,hsvColor,whiteLevel,blackLevel}
...
[46]: https://developer.mozilla.org/docs/Web/API/Window
